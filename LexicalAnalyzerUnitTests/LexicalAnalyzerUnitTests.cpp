...
namespace LexicalAnalyzerUnitTests
{
    ...
    public:
        ...
        TEST_METHOD(ShouldParseSeparatorCase1)
        {
            ...
            auto lexeme_type = res[0].m_lexeme_class;
            Assert::IsTrue(lexeme_type == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
        }
        ...
        TEST_METHOD(ShouldParseKeywordSeparatorIdentifierCase1)
        {
            ...
            Assert::IsTrue(lexeme_type2 == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
        ...
        TEST_METHOD(ShouldParseIntegerCase1)
        {
            ...
            Assert::IsTrue(res.size() == 1);
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
        }
        ...
        TEST_METHOD(ShouldParseIntegerCase2)
        {
            ...
            Assert::IsTrue(res.size() == 9);
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[1].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[2].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[3].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[4].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[5].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[6].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[7].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
            Assert::IsTrue(res[8].m_lexeme_class == LanguageInfoCpp::LC_INTEGER_LITERAL);
        }
        ...
        TEST_METHOD(ShouldAcceptCharacherLiteralCase1)
        {
            ...
            Assert::IsTrue(res.size() == 1);
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_CHARACTER_LITERAL);
        }
        ...
        TEST_METHOD(ShouldAcceptFloatingLiteralIntegralCase1)
        {
            ...
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[1].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[2].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[3].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[4].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[5].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[6].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[7].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[8].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
            Assert::IsTrue(res[9].m_lexeme_class == LanguageInfoCpp::LC_FLOATING_LITERAL);
        }
        ...
        TEST_METHOD(ComplexTest1)
        {
            ...
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_KEYWORD);
            Assert::IsTrue(res[1].m_lexeme_class == LanguageInfoCpp::LC_KEYWORD);
            Assert::IsTrue(res[2].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[3].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[4].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[5].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[6].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[7].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[8].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[9].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[10].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[11].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[12].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[13].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[14].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[15].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            Assert::IsTrue(res[16].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
        }
        ...
        TEST_METHOD(ShouldReturnLexemeValueAndPosition)
        {
            ...
            Assert::IsTrue(res[2].m_lexeme_class == LanguageInfoCpp::LC_IDENTIFIER);
            Assert::IsTrue(res[2].m_lexeme_value == "a");
            Assert::IsTrue(res[2].m_lexeme_position == 12);

            Assert::IsTrue(res[3].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
            ...
            Assert::IsTrue(res[5].m_lexeme_class == LanguageInfoCpp::LC_PUNCTUATION_OR_OPERATOR);
        ...
        TEST_METHOD(ShouldParseBooleanLiterals)
        {
            ...
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_BOOLEAN_LITERAL);
            Assert::IsTrue(res[0].m_lexeme_value == "true");
            Assert::IsTrue(res[0].m_lexeme_position == 0);

            Assert::IsTrue(res[1].m_lexeme_class == LanguageInfoCpp::LC_BOOLEAN_LITERAL);
        ...
        TEST_METHOD(ShouldPartPointerLiteral)
        {
            ...
            Assert::IsTrue(res[0].m_lexeme_class == LanguageInfoCpp::LC_POINTER_LITERAL);
